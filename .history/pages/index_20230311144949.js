...
import { randomMaze } from "../mazes/recursiveDivision";
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.buttons}>
        ...
        <button onClick={() => visualizeBestfs(grid, setGrid)}>
          Visualize Best First Search
        </button>
        <button onClick={() => visualizeBritishMuseum(grid, setGrid)}>
          Visualize British Museum
        </button>
        <button onClick={() => setGrid(getInitialGrid())}>Clear Board</button>
      </div>
      <div className={styles.buttons}>
        <button onClick={() => randomMaze(grid, setGrid)}>Random Maze</button>
      </div>
      {grid.map((row, index) => (
