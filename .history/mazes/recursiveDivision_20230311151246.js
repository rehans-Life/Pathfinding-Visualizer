...
export function randomMaze(grid, setGrid) {
  ...
  animateWalls(firstRow, newGrid, setGrid);
  ...
  animateWalls(boundryColumns, newGrid, setGrid);
  ...
  for (let i = 0; i < COLS; i++) {
    ...
    lastRow.push(lastRowNode);
  }

  animateWalls(lastRow, newGrid, setGrid);
...
function animateWalls(nodes, grid, setGrid) {
