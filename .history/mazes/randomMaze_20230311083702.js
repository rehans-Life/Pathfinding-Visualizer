...
function divide(grid, minRow, maxRow, minCol, maxCol, direction, prevSpace) {
  if (direction === "row") {
    ...
    divide(grid, minRow, randomRow - 1, minCol, maxCol, "col", randomSpace);
    divide(grid, randomRow + 1, maxRow, minCol, maxCol, "col", randomSpace);
  } else {
    ...
    divide(grid, minRow, maxRow, minCol, randomCol - 1, "row", randomSpace);
    divide(grid, minRow, maxRow, randomCol + 1, maxCol, "row", randomSpace);
  }
}
