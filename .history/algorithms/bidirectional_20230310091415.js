...
function bidirectional(grid, src, target) {
  ...
  while (forwardQueue.length && backwardQueue.length) {
    bfs(grid, forwardQueue, forwardVisitedNodes,backwardVisitedNodes, "Forward");
    bfs(grid, backwardQueue, backwardVisitedNodes,forwardVisitedNodes, "Backward");
  }
  return visitedNodes;
}

function bfs(grid, queue, visitedNodes, direction) {
    if ()
